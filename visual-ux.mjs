...
ok(await page.locator('.hallcard').count()===1&&/You walk into/.test(await txt()),'“Play the round” walks you into the hall first');
await page.click('[data-act="hallstart"]');await page.waitForTimeout(800);
